...
public class LibraryKikiPlaylistDetailFragment extends Fragment implements PlaylistDetailAdapter.OnPlaylistDetailItemClickListener, AddSongToPlaylistDialogAdapter.OnPlaylistDialogItemClickListener {
    @Inject
    TvManager tvManager;

    FragmentLibraryHomePlaylistDetailBinding binding;
    ...
    public LibraryKikiPlaylistDetailFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_library_home_playlist_detail, container, false);
        ...
        playlistDetailAdapter = new PlaylistDetailAdapter(getActivity(), playlistSongsList, LibraryKikiPlaylistDetailFragment.this);
        ...
        tvManager.getSongsOfDailymix(playlistID,  new APIListener<List<Song>>() {
            ...
            public void onSuccess(List<Song> result, List<Object> params) {
                ...
                binding.playlistSongsRecyclerview.setAdapter(new PlaylistDetailAdapter(getContext(),
                        playlistSongsList, LibraryKikiPlaylistDetailFragment.this));
                if (result.size() <= 0) {
    ...
    private void addToLibraryPlaylistDialog(List<PlayList> playLists) {
        ...
        AddSongToPlaylistDialogAdapter adapter = new AddSongToPlaylistDialogAdapter(getActivity(),playLists,LibraryKikiPlaylistDetailFragment.this);
    ...
    public void onPlaylistDialogItemClick(PlayList playList, int position, List<PlayList> songs) {
            ...
            int userPlaylistID = playList.getId();
