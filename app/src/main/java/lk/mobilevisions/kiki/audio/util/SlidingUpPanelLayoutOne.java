...
public class SlidingUpPanelLayoutOne extends ViewGroup {

    private static final String TAG = SlidingUpPanelLayoutOne.class.getSimpleName();
    ...
    public SlidingUpPanelLayoutOne(Context context) {
        this(context, null);
    }

    public SlidingUpPanelLayoutOne(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SlidingUpPanelLayoutOne(Context context, AttributeSet attrs, int defStyle) {
            ...
            mDragView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (mSlideState != PanelState.EXPANDED && mSlideState != PanelState.ANCHORED) {
                        ...
                        System.out.println("bkbfkbkbfbf ");
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        System.out.println("bkbfkbkbfbf 11111 ");
        if (!isEnabled() || !isTouchEnabled()) {
    ...
    public void setPanelState(PanelState state) {
        System.out.println("bkbfkbkbfbf 2222 " + state);
