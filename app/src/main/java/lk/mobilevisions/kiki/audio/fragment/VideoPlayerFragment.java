...
import lk.mobilevisions.kiki.databinding.FragmentVideoPlayerBinding;
...
public class VideoPlayerFragment extends Fragment implements SurfaceHolder.Callback, View.OnClickListener,
        ExoPlayer.Listener, ExoPlayer.CaptionListener, ExoPlayer.Id3MetadataListener,
        AudioCapabilitiesReceiver.Listener, MediaControllerListener {

    private static final int MENU_GROUP_TRACKS = 1;
    private static final int ID_OFFSET = 2;
    private static final int MEDIA_CONTROLLER_REMOVE_DELAY = 8000;
...
//    }
    ...
    private BroadcastReceiver phoneStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            VideoPlayerFragment.this.onPhoneStateChange(intent);
        }
    };
...
//        binding.buttonViewMoreClose.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
//                binding.viewMoreOptions.setVisibility(View.GONE);
//            }
//        });
//
//
...
//        });
//
//        binding.buttonSubtitles.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View view) {
...
//
//                System.out.println("dfhaeigiaegiuo 1111 " + player.getPlaybackState());
//                if (PLAYER.getCurrentVideoContentURI() != null) {
//                    System.out.println("dfhaeigiaegiuo 2222 " );
//                    if (player.getPlaybackState() == 4) {
//                        System.out.println("dfhaeigiaegiuo 3333 ");
//                        loadRemoteMedia((int) PLAYER.getCurrentVideoPosition(), true);
//                        doPauseResume();
//                        return;
//                    }
//                }
//                System.out.println("dfhaeigiaegiuo 4444 ");
//                getActivity().invalidateOptionsMenu();
//            }
//
//            private void onApplicationDisconnected() {
//                System.out.println("dfhaeigiaegiuo 5555 ");
...
//            }
//        });
////        System.out.println("checking 8888 " +PLAYER.getCurrentVideoContentURI());
...
//            System.out.println("checking video url 8888 " + PLAYER.getCurrentVideoContentURI());
//            movieMetadata.putString(MediaMetadata.KEY_SUBTITLE, Application.PLAYER.getEpisodes().get(Application.PLAYER.getCurrentVideo()).getDescription());
//            movieMetadata.putString(MediaMetadata.KEY_TITLE, Application.PLAYER.getEpisodes().get(Application.PLAYER.getCurrentVideo()).getName());
//            movieMetadata.addImage(new WebImage(Uri.parse(URLDecoder.decode(Application.PLAYER.getEpisodes().get(Application.PLAYER.getCurrentVideo()).getImage(), "UTF-8"))));
////
//            String url = URLDecoder.decode(Application.PLAYER.getEpisodes().get(Application.PLAYER.getCurrentVideo()).getVideoLink(), "UTF-8");
//            System.out.println("checking video url 9999 " + url);
////            url = "https://commondatastorage.googleapis.com/gtv-videos-bucket/CastVideos/hls/DesigningForGoogleCast.m3u8"
////            url = "https://cdn.kiki.lk/vod/smil:3603.smil/playlist.m3u8?token=fc6eb2a2-f8f9-4f7e-bc7b-2339891f45cf&tokenHash=NIVtMKjzA3ZnB51mjhT8rbnp09FlqclZ1KfKXKC5SwZpTEu7NrKNtrpWB5BRNRNIqNp8hRa2BsbL1OEDF9Fd2uA11"
...
//        }
//
//        System.out.println("checking 8888 " + player.getDuration());
//        return null;
//
//    }
                                        ...
                                        if ((content.getWebURL().startsWith("app://") || URLUtil.isValidUrl(content.getWebURL()))) {
                                            binding.imageAdvertisementFullScreenView.setOnClickListener(new View.OnClickListener() {
                                                ...
                                                public void onClick(View v) {
                                                    Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(content.getWebURL()));
...
//                if(getContext() != null){
//                    subtitles = ((Application) getContext().getApplicationContext()).PLAYER.getSubtitles() + 1;
//                }
//                popupSubtitles.getMenu().getItem(subtitles).setChecked(true);
//                onTrackItemClick(popupSubtitles.getMenu().getItem(subtitles), ExoPlayer.TYPE_TEXT);
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                ...
                case TelephonyManager.CALL_STATE_RINGING:
                    ...
                    if (VideoPlayerFragment.this != null) {
                        VideoPlayerFragment.this.doPause();
