...
public class GenreArtistListFragment extends Fragment implements GenreArtistListAdapter.OnArtistItemClickListener {
    ...
    public GenreArtistListFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mAdapter = new GenreArtistListAdapter(getActivity(), artistArrayList, GenreArtistListFragment.this);
        ...
        tvManager.getAllArtists(0,200, new APIListener<List<Artist>>() {
            ...
            public void onSuccess(List<Artist> result, List<Object> params) {
                ...
                binding.artistListRecycle.setAdapter(new GenreArtistListAdapter(getContext(),
                        artistArrayList, GenreArtistListFragment.this));
                if (result.size() <= 0) {
