...
import lk.mobilevisions.kiki.audio.util.ImageUtils;
import lk.mobilevisions.kiki.audio.util.NavigationUtils;
import lk.mobilevisions.kiki.audio.util.SlideTrackSwitcher;
import lk.mobilevisions.kiki.ui.widgets.PlayPauseButton;
...
//        mTitle.setText("wghwfj");
//        mArtist.setText("adfhakfhj");
        mTitleExpanded.setText("adhfadhf");
        mArtistExpanded.setText("shjflhfn");
        if (!duetoplaypause) {
            ImageLoader.getInstance().displayImage("https://www.google.lk/search?q=havana&safe=active&source=lnms&tbm=isch&sa=X&ved=0ahUKEwjTnPTG3ZbdAhWDfn0KHQWsD1EQ_AUICygC&biw=1366&bih=662#imgdii=Sk-5lYrgzTi1AM:&imgrc=fwHKnFI5eUmf7M:", mAlbumArt,
                    new DisplayImageOptions.Builder().cacheInMemory(true)
                        ...
                        public void onLoadingFailed(String imageUri, View view, FailReason failReason) {
                            Bitmap failedBitmap = ImageLoader.getInstance().loadImageSync("drawable://" + R.drawable.ic_havana);
//                            if (getActivity() != null)
