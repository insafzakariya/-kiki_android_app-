...
public class PlaylistDetailFragment extends Fragment implements PlaylistDetailAdapter.OnPlaylistDetailItemClickListener , AddSongToPlaylistDialogAdapter.OnPlaylistDialogItemClickListener {
    @Inject
    TvManager tvManager;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        playlistDetailAdapter = new PlaylistDetailAdapter(getActivity(), playlistSongsList, PlaylistDetailFragment.this);
        ...
        tvManager.getSongsOfDailymix(playlistID,  new APIListener<List<Song>>() {
            ...
            public void onSuccess(List<Song> result, List<Object> params) {
                ...
                binding.playlistSongsRecyclerview.setAdapter(new PlaylistDetailAdapter(getContext(),
                        playlistSongsList, PlaylistDetailFragment.this));
                if (result.size() <= 0) {
    ...
    private void addToLibraryPlaylistDialog(List<PlayList> playLists) {
        ...
        AddSongToPlaylistDialogAdapter adapter = new AddSongToPlaylistDialogAdapter(getActivity(),playLists,PlaylistDetailFragment.this);
