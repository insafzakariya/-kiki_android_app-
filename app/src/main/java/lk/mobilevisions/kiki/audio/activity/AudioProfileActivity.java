...
import lk.mobilevisions.kiki.databinding.ActivityAudioProfileBinding;
...
public class AudioProfileActivity extends AppCompatActivity implements View.OnClickListener {
    @Inject
    AuthManager authManager;
    ActivityAudioProfileBinding binding;
    private String selectedLanguage = "English";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = DataBindingUtil.setContentView(this, R.layout.activity_audio_profile);
        ...
        ((Application) getApplication()).getAnalytics().setCurrentScreen(this, "AudioProfileActivity", null);
        binding.includedToolbar.titleTextview.setText("Profile");
    ...
    private void getUserDetails() {
        ...
        authManager.getUserDetails(new APIListener<AuthUser>() {
            ...
            public void onFailure(Throwable t) {
                ...
                Utils.Error.onServiceCallFail(AudioProfileActivity.this, t);
            }
        });
    }
    ...
    private void updateProfileDetails() {
        ...
        if (((Activity) AudioProfileActivity.this).hasWindowFocus()) {
            progressDialog.show();
        }
        ...
        authManager.updateUserDetails(user, new APIListener<AuthUser>() {
            ...
            public void onSuccess(AuthUser result, List<Object> params) {
                ...
                setUpAppLanguage();
                Intent intent = new Intent(AudioProfileActivity.this, AudioDashboardActivity.class);
