...
public class PlaylistVerticalAdapter  extends
    ...
    public PlaylistVerticalAdapter (Context mContext,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new GenrePlaylistRecyclerViewHolder(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        initLayoutTwo((GenrePlaylistRecyclerViewHolder) holder, position);

    }


    private void initLayoutTwo(final GenrePlaylistRecyclerViewHolder holder, int pos) {
    ...
    class GenrePlaylistRecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        public GenrePlaylistRecyclerViewHolder(View itemView) {
            super(itemView);
