...
public class LibraryHomeArtistListAdapter extends
    ...
    public LibraryHomeArtistListAdapter(Context mContext, List<Artist> artistList, OnArtistItemClickListener itemClickListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.library_home_artist_list, parent, false);
        return new ArtistHomeViewHolder(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        initLayoutOne((ArtistHomeViewHolder) holder, position);


    }

    private void initLayoutOne(final ArtistHomeViewHolder holder, int pos) {
...
//        holder.songDuration.setText(NavigationUtils.convertMinutesToFormat(current.getDuration()));
        ...
        holder.removeImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                itemClickListener.onRemoveArtistItemClick(artistList.get(holder.getAdapterPosition()));
            }
        });
    }
    ...
    class ArtistHomeViewHolder extends RecyclerView.ViewHolder {
        ...
        public ArtistHomeViewHolder(View itemView) {
            super(itemView);
