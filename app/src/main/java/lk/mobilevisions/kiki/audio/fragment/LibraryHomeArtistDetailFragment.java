...
import lk.mobilevisions.kiki.databinding.FragmentLibraryArtistDetailBinding;
import lk.mobilevisions.kiki.modules.api.APIListener;
import lk.mobilevisions.kiki.modules.subscriptions.SubscriptionsManager;
import lk.mobilevisions.kiki.modules.tv.TvManager;

public class LibraryHomeArtistDetailFragment extends Fragment implements GenreSongsVerticalAdapter.OnGenreSongsItemActionListener  {

    @Inject
    TvManager tvManager;

    FragmentLibraryArtistDetailBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_library_artist_detail, container, false);
