...
public class PersistentSearchView extends RevealViewGroup {
    ...
    private static final int[] RES_IDS_ACTION_BAR_SIZE = { org.cryse.widget.persistentsearch.R.attr.actionBarSize };
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray attrsValue = getContext().obtainStyledAttributes(attrs,
                    org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView);
            mDisplayMode = DisplayMode.fromInt(attrsValue.getInt(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_displayMode, DisplayMode.MENUITEM.toInt()));
            mSearchCardElevation = attrsValue.getDimensionPixelSize(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_searchCardElevation, -1);
            mSearchTextColor = attrsValue.getColor(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_searchTextColor, Color.BLACK);
            mLogoDrawable = attrsValue.getDrawable(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_logoDrawable);
            mStringLogoDrawable = attrsValue.getString(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_logoString);
            mSearchEditTextColor = attrsValue.getColor(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_editTextColor, Color.BLACK);
            mSearchEditTextHint = attrsValue.getString(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_editHintText);
            mSearchEditTextHintColor = attrsValue.getColor(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_editHintTextColor, Color.BLACK);
            mCustomToolbarHeight = attrsValue.getDimensionPixelSize(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_customToolbarHeight, calculateToolbarSize(getContext()));
            mHomeButtonMode = attrsValue.getInt(org.cryse.widget.persistentsearch.R.styleable.PersistentSearchView_persistentSV_homeButtonMode, 0);
            attrsValue.recycle();
        }

        if (mSearchCardElevation < 0) {
            mSearchCardElevation = getContext().getResources().getDimensionPixelSize(org.cryse.widget.persistentsearch.R.dimen.search_card_default_card_elevation);
        }

        mCardHeight = getResources().getDimensionPixelSize(org.cryse.widget.persistentsearch.R.dimen.search_card_height);
        mCardVerticalPadding = (mCustomToolbarHeight - mCardHeight) / 2;

        switch (mDisplayMode) {
            case MENUITEM:
            default:
                mCardHorizontalPadding = getResources().getDimensionPixelSize(org.cryse.widget.persistentsearch.R.dimen.search_card_visible_padding_menu_item_mode);
            ...
            case TOOLBAR:
                ...
                mCardHorizontalPadding = getResources().getDimensionPixelSize(org.cryse.widget.persistentsearch.R.dimen.search_card_visible_padding_toolbar_mode);
                setCurrentState(SearchViewState.NORMAL);
                break;
        }
    ...
    private void bindViews() {
        this.mSearchCardView = (CardView) findViewById(org.cryse.widget.persistentsearch.R.id.cardview_search);
        this.mHomeButton = (HomeButton) findViewById(org.cryse.widget.persistentsearch.R.id.button_home);
        this.mLogoView = (LogoView) findViewById(org.cryse.widget.persistentsearch.R.id.logoview);
        this.mSearchEditText = (EditText) findViewById(org.cryse.widget.persistentsearch.R.id.edittext_search);
        this.mSuggestionListView = (ListView) findViewById(org.cryse.widget.persistentsearch.R.id.listview_suggestions);
        this.mMicButton = (ImageView) findViewById(org.cryse.widget.persistentsearch.R.id.button_mic);
    }
    ...
    private void setValuesToViews() {
        ...
        this.mHomeButton.setImageDrawable(
                ResourcesCompat.getDrawable(getResources(), R.drawable.ic_arrow_left, null));
    ...
    private void setUpLayoutTransition() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            RelativeLayout searchRoot = (RelativeLayout) findViewById(org.cryse.widget.persistentsearch.R.id.search_root);
    ...
    public void setHomeButtonColor(int mArrorButtonColor) {
