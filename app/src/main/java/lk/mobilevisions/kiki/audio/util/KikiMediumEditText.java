...
public class KikiMediumEditText extends AppCompatEditText {

    public static final String ANDROID_SCHEMA = "http://schemas.android.com/apk/res/android";
    Paint.FontMetricsInt fontMetricsInt;

    public KikiMediumEditText(Context context) {
        super(context);

        applyCustomFont(context, null);
    }

    public KikiMediumEditText(Context context, AttributeSet attrs) {
        super(context, attrs);

        applyCustomFont(context, attrs);
    }

    public KikiMediumEditText(Context context, AttributeSet attrs, int defStyle) {
