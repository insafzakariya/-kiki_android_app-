...
public class AnimatedExpandableListView extends ExpandableListView {
     ...
     * instance for group expansion, we tell the adapter_program_item to animate the
     ...
     * ExpandableListView does this is by calling getView() in the adapter_program_item.
     * However since the adapter_program_item knows that we are animating a certain group,
     ...
     * adapter_program_item to stop animating the group and call notifyDataSetChanged. Now
     ...
     *
     * 1. The ExpandableListView tells the adapter_program_item to animate a certain group.
     ...
     * 5. Since the adapter_program_item is in "animating mode", it will return a dummy view.
     ...
     * 8. Once the animation completes, the adapter_program_item is notified to stop
     ...
     * 4. Since the adapter_program_item is in "animating mode", it will return a dummy view.
     ...
     * 7. Once the animation completes, the adapter_program_item is notified to stop
     *    animating the group and notifyDataSetChanged is called again.
    ...
    public void setAdapter(ExpandableListAdapter adapter) {
        ...
        // Make sure that the adapter_program_item extends AnimatedExpandableListAdapter
    ...
    public boolean expandGroupWithAnimation(int groupPos) {
        ...
        if (groupFlatPos != -1) {
            ...
            if (childIndex < getChildCount()) {
                ...
                if (v.getBottom() >= getBottom()) {
                    ...
                    // We need to notify the adapter_program_item that the group was expanded
        ...
        // Let the adapter_program_item know that we are starting the animation...
    ...
    public boolean collapseGroupWithAnimation(int groupPos) {
        ...
        // Let the adapter_program_item know that we are going to start animating the
        // collapse animation.
    ...
    /**
     * A specialized adapter_program_item for use with the AnimatedExpandableListView. All
