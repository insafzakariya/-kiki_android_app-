...
import lk.mobilevisions.kiki.databinding.ActivitySearchedplaylistsBinding;

public class SearchedPlaylistsActivity extends AppCompatActivity implements View.OnClickListener {

    ActivitySearchedplaylistsBinding binding;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = DataBindingUtil.setContentView(this, R.layout.activity_searchedplaylists);
