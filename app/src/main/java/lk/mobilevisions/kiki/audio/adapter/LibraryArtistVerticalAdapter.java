...
public class LibraryArtistVerticalAdapter extends
    ...
    public LibraryArtistVerticalAdapter(Context mContext,
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new LibraryArtistesRecyclerViewHolder(view);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        initLayoutTwo((LibraryArtistesRecyclerViewHolder) holder, position);

    }


    private void initLayoutTwo(final LibraryArtistesRecyclerViewHolder holder, int pos) {
    ...
    class LibraryArtistesRecyclerViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.image)
        ImageView imageView;
        public LibraryArtistesRecyclerViewHolder(View itemView) {
            super(itemView);
