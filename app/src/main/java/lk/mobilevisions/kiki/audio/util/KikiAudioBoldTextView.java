...
public class KikiAudioBoldTextView extends AppCompatTextView {

    public static final String ANDROID_SCHEMA = "http://schemas.android.com/apk/res/android";
    Paint.FontMetricsInt fontMetricsInt;

    public KikiAudioBoldTextView(Context context) {
        super(context);

        applyCustomFont(context, null);
    }

    public KikiAudioBoldTextView(Context context, AttributeSet attrs) {
        super(context, attrs);

        applyCustomFont(context, attrs);
    }

    public KikiAudioBoldTextView(Context context, AttributeSet attrs, int defStyle) {
