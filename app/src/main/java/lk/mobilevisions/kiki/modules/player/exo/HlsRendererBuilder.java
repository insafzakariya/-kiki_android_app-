 ...
 */
package lk.mobilevisions.kiki.modules.player.exo;
...
public class HlsRendererBuilder implements ExoPlayer.RendererBuilder {
  ...
  public HlsRendererBuilder(Context context, String userAgent, String url) {
    System.out.println("HlsRendererBuilder checking  111  " + url);
  ...
  private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url, ExoPlayer player) {
      System.out.println("HlsRendererBuilder checking  222  " + url);
      this.context = context;
      this.userAgent = userAgent;
      this.player = player;
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
     ...
     // Cache cache = new SimpleCache(new File(context.getCacheDir(), "media_cache"), new LeastRecentlyUsedCacheEvictor(1024 * 1024 * 100));
     ...
     // CacheDataSource cacheDataSource = new CacheDataSource(cache, dataSource, false, false);
      ...
      System.out.println("HlsRendererBuilder checking  333  " + dataSource.toString());
      System.out.println("HlsRendererBuilder checking  444  " + chunkSource.toString());
