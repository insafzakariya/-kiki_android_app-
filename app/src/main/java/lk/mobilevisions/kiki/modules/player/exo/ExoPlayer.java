...
import lk.mobilevisions.kiki.modules.player.CustomPlayerControl;
...
public class ExoPlayer implements com.google.android.exoplayer.ExoPlayer.Listener, ChunkSampleSource.EventListener,
    ...
    StreamingDrmSessionManager.EventListener, DashChunkSource.EventListener, TextRenderer,
        MetadataRenderer<List<Id3Frame>>, DebugTextViewHelper.Provider, Serializable {
  ...
  private final CustomPlayerControl playerControl;
  ...
  public ExoPlayer(RendererBuilder rendererBuilder) {
    ...
    playerControl = new CustomPlayerControl(player);
  ...
  public CustomPlayerControl getPlayerControl() {
