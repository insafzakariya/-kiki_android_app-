 ...
 */
public class EventLogger implements lk.mobilevisions.kiki.modules.player.exo.ExoPlayer.Listener,
        lk.mobilevisions.kiki.modules.player.exo.ExoPlayer.InfoListener,
        lk.mobilevisions.kiki.modules.player.exo.ExoPlayer.InternalErrorListener {
    ...
    public EventLogger() {
        loadStartTimeMs = new long[lk.mobilevisions.kiki.modules.player.exo.ExoPlayer.RENDERER_COUNT];
    }
