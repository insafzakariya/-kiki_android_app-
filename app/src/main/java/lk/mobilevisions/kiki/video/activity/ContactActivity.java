...
import lk.mobilevisions.kiki.databinding.ActivityContactBinding;
...
public class ContactActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void callSupport() {
        ...
        startActivity(Intent.createChooser(callIntent,"Support KiKi"));
    }

    private void emailSupport() {
        Intent emailIntent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts(
                "mailto", Utils.App.getConfig(getApplication()).getContactEmail(), null));
        startActivity(Intent.createChooser(emailIntent, "Support KiKi"));
    }
}
