...
import lk.mobilevisions.kiki.databinding.ActivityNotificationsBinding;
...
public class NotificationsActivity extends AppCompatActivity implements NotificationsAdapter.OnNotificationItemClickListener, View.OnClickListener {
        ...
        notificationManager.getNotifications(NOTIFICATION_LIMIT, new APIListener<List<Notification>>() {
            ...
            public void onSuccess(List<Notification> notifications, List<Object> params) {
                ...
                if(notifications.size()>0){
                    ...
                    notificationsLayoutManager = new LinearLayoutManager(NotificationsActivity.this);
                    binding.recycleViewNotification.setLayoutManager(notificationsLayoutManager);
                    notificationsAdapter = new NotificationsAdapter(NotificationsActivity.this, notifications, NotificationsActivity.this);
                    binding.recycleViewNotification.setAdapter(notificationsAdapter);
                    binding.recycleViewNotification.addItemDecoration(new DividerItemDecoration(NotificationsActivity.this, R.drawable.episode_line_divider));
                ...
                if (readNotificationIds.size() > 0) {
                    notificationManager.markNotificationAsRead(readNotificationIds, new APIListener<Void>() {
                        ...
                        public void onFailure(Throwable t) {
                            Utils.Error.onServiceCallFail(NotificationsActivity.this, t);
                        }
                    });
                }
