...
import lk.mobilevisions.kiki.audio.util.FontCache;
...
public class MaterialSpinner extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private Typeface selectTypeface(Context context, int textStyle) {
        ...
        return FontCache.getTypeface("NeufvilleDigital-FuturaNext-Medium.otf", context);
...
//        setBackgroundResource(R.drawable.ms__selector);
    ...
    public void setSelectedIndex(int position) {
        if (adapter != null) {
            if (position >= 0 && position <= adapter.getCount()) {
                ...
                throw new IllegalArgumentException("Position must be lower than adapter_program_item count!");
            }
        }
    }
    ...
    /**
     * Set a custom adapter_program_item for the dropdown items
     *
     * @param adapter The list adapter_program_item
     */
    ...
    /**
     * Set the custom adapter_program_item for the dropdown items
     *
     * @param adapter The adapter_program_item
     * @param <T>     The type
     */
    ...
    /**
     * Get the list of items in the adapter_program_item
     *
     * @param <T> The item type
    ...
    public interface OnItemSelectedListener<T> {
         ...
         * @param position The position of the view in the adapter_program_item
