 ...
 */
public class HotVideosFragment extends Fragment implements EpisodesAdapter.OnEpisodesItemClickListener {
    ...
    public void onResume() {
        super.onResume();
        Application.PLAYER.setVideoType(GlobalPlayer.VideoType.HOT_VIDEOS);
    ...
    public void onTabChanged(MainActivity.TabChangedEvent event) {
        if (event.getPosition() == VideoTabs.HOT_VIDEOS.getValue()) {
            Application.PLAYER.setVideoType(GlobalPlayer.VideoType.HOT_VIDEOS);
            getActivity().setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
            tvManager.getHotVideos(channelId, new APIListener<List<Program>>() {
                @Override
                public void onSuccess(List<Program> programs, List<Object> params) {
                    ...
                    episodesAdapter = new EpisodesAdapter(getContext(), episodes, HotVideosFragment.this);
