 ...
 */
public class AllSubscribedVideosFragment extends Fragment implements ProgramsAdapter.OnProgramItemClickListener {
...
//    }
    ...
    private void loadSubscribeList(){
        ...
        tvManager.getSubscribedPrograms(channelId,0, programsLimit, new APIListener<List<Program>>() {
            @Override
            public void onSuccess(List<Program> programs, List<Object> params) {
                programsAdapter = new ProgramsAdapter(getActivity(), programs, AllSubscribedVideosFragment.this
