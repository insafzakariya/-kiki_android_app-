...
import lk.mobilevisions.kiki.databinding.ActivityMySubscribedPackagesBinding;
...
public class MySubscribePackagesActivity extends AppCompatActivity {


    ActivityMySubscribedPackagesBinding binding;
    @Inject
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_my_subscribed_packages);
                    ...
                    public void onSuccess(final PackageToken packageToken, List<Object> params) {
                        ...
                        subscriptionsManager.getActivatedPackage(new APIListener<Package>() {
                            ...
                            public void onSuccess(Package thePackage, List<Object> params) {
                                ...
                                final Intent intent = new Intent(MySubscribePackagesActivity.this, PaymentActivity.class);
                                intent.putExtra("paymentTokenHash", packageToken.getTokenHash());
                                startActivity(intent);

//                                if (thePackage.getId() == 46 || thePackage.getId() == 81) {
////                                    new MaterialDialog.Builder(MySubscribePackagesActivity.this)
...
//                                }
                            ...
                            public void onFailure(Throwable t) {
                                binding.aviProgress.setVisibility(View.GONE);
                                Utils.Error.onServiceCallFail(MySubscribePackagesActivity.this, t);
                            }
                        });
                    }
